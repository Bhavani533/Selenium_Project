...
public class TeacherModule {
	...
	public static void main(String[] args) {
		...
		//sign up as a teacher
		 ...
		 driver.findElement(By.id("username")).sendKeys("teju1237");
		 ...
		 try{
			 if(driver.findElement(By.xpath("//*[@id=\"registration\"]/fieldset/div[5]/div[1]/span")).isDisplayed())
			 {
			 //Homepage
			 driver.get("http://elearningm1.upskills.in/");

			 //login
			 driver.findElement(By.id("login")).sendKeys("teju1237");
		...
		//Javascript for scrolling down
		 ...
		 //Adding new course
		 driver.findElement(By.id("title")).sendKeys("Java Basics Tutorial4");
		 driver.findElement(By.id("add_course_submit")).click();
		 
		 //driver.findElement(By.xpath("//*[title='My courses']")).click();
		 driver.findElement(By.linkText("Java Basics Tutorial4")).click();
